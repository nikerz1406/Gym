...
public class EmployeeListPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblEmployee.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Full Name", "Phone", "Gender", "Role", "Status"
            }
        ) {
    ...
    private void tblEmployeeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmployeeMouseClicked
        ...
        EmployeeMainPanel.selectedId = Integer.parseInt(modelEmployee.getValueAt(selectedRow, 0).toString());
    ...
    private void starter() {
        try {
            ...
            employeeS = dao.select(columnNameS, "employee", "1=1");
            fillTblEmployee();
        } catch (SQLException ex) {
            System.out.println("EmployeeListPanel - starter: " + ex);
        }
    }

    private void fillTblEmployee() {
        DefaultTableModel modelEmployee = (DefaultTableModel) tblEmployee.getModel();
        modelEmployee.setRowCount(0);
        employeeS.forEach(i -> {
            Object id = i.get(0);
            Object name = i.get(1);
            Object phone = i.get(2);
            Object gender = "";
            switch (Integer.parseInt(i.get(3).toString())) {
                case 1:
                    gender = "Male";
                    break;
                case 2:
            ...
            Object role = "";
            if (Integer.parseInt(i.get(4).toString()) == 1) {
                role = "Assistant";
            } else {
                role = "Manager";
            }
            Object status;
            if (Integer.parseInt(i.get(5).toString()) == 1) {
                status = "Active";
            } else {
                status = "Inactive";
            }
            Object[] dataRow = new Object[]{id, name, phone, gender, role, status};
            modelEmployee.addRow(dataRow);
        });
    }

    private void tableSort() {
        TableRowSorter<DefaultTableModel> sorter = new TableRowSorter<>((DefaultTableModel) tblEmployee.getModel());
        tblEmployee.setRowSorter(sorter);
    }

    private void recordSum() {
        lblRecord.setText(String.valueOf(tblEmployee.getRowCount()));
    }
    //end custom-code
}
